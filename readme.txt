...
Ultimate Category Excluder (Beta) is for testing Ultimate Category Excluder in real world environments. Not for production use!

== Description ==

Ultimate Category Excluder (Beta), abbreviated as UCE, is a WordPress plugin that allows you to quickly and easily exclude categories from your front page, archives, feeds, and searches. Just select which categories you want to be excluded, and UCE does all the work for you!

The Beta version is exactly the same as the regular version, but is upgraded more frequently while I'm trying to find bugs in different combinations of other themes and plugins. If you don't have the ability to troubleshoot problems, please do not use the Beta plugin. Definitely do not use the Beta on a production web site. If you don't know what that means, do not use the Beta! The version you should use is at http://wordpress.org/plugins/ultimate-category-excluder/

Please report any problems with UCE to me at *mclark -at- planetmike.com*. Please include the system information that is found at the bottom of the UCE settings page.

== Installation ==

1. Download Ultimate Category Excluder.
2. Unzip the ultimate-category-excluder-beta.zip file.
...
= When I go to my search results page for any search I do, I get this PHP error: Warning: Invalid argument supplied for foreach() in /wp-content/plugins/ultimate-category-excluder/ultimate-category-excluder.php on line 146 =
...
= 0.97 =
* September 14, 2013 - Fixed a bug regarding searches within the wp-admin area.
